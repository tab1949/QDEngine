...
pub struct MdLogin {
    ...
    pub login_dr_identity_id: Option<i32>,
    pub user_dr_identity_id: Option<i32>,
...
pub struct OrderInserted {
    ...
    pub order_submit_status: Option<i8>,
    pub order_status: Option<i8>,
    pub volume_traded: Option<i32>,
    pub volume_total: Option<i32>,
    pub status_msg: Option<String>,
    pub direction: Option<i8>,
    pub offset: Option<i8>,
    pub price_type: Option<i8>,
    pub hedge: Option<i8>,
    pub time_condition: Option<i8>,
}
...
pub struct OrderTraded {
    ...
    pub order_sys_id: Option<String>,
    pub order_local_id: Option<String>,
    pub broker_order_seq: Option<i32>,
    pub settlement_id: Option<i32>,
...
pub struct OrderInsertError {
    ...
    pub volume_total_original: Option<i32>,
    pub min_volume: Option<i32>,
    pub order_memo: Option<String>,
    pub order_ref: Option<String>,
    pub request_id: Option<i32>,
    pub session_req_seq: Option<i32>,
    pub direction: Option<i8>,
    pub offset: Option<i8>,
    pub price_type: Option<i8>,
    pub hedge: Option<i8>,
...
pub struct OrderDeleteError {
    pub broker_id: Option<String>,
    pub investor_id: Option<String>,
    pub order_action_ref: Option<i32>,
    pub order_ref: Option<String>,
    pub request_id: Option<i32>,
    pub front_id: Option<i32>,
    pub session_id: Option<i32>,
